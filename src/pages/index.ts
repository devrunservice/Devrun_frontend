...
export {default as Certifications} from './User/Certification/Certifications';
export {default as CertificationDetail} from './User/Certification/CertificationDetail';
...
export {default as QuestionDetail} from './User/Questions/QuestionDetail';
...
export {default as NoticeRetouch} from './Notice/Retouch/Retouch';
